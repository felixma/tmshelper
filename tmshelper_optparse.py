...
def main():
    #parse('tms_template.xlsx')
    #schedule()
    #plan('tms_template.xlsx')
    #script('tms_template.xlsx')
    ...
    parser.add_option('-h', '--help', action = 'store')
    parser.add_option('-i', action='store', dest = 'testplan')
    parser.add_option('-a', action='store_true', dest = 'all')
    parser.add_option('-s', action='store_true', dest = 'schedonly')
    parser.add_option('-p', action='store_true', dest = 'planonly')
    parser.add_option('-t', action='store_true', dest = 'scriptonly')
